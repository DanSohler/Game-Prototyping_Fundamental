...
public class Slingshot : MonoBehaviour
{
    ...
    // Vars for slinging/line drawing
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            {
              //  Vector3 currentPlayerPoint = rb.transform.position;
                Vector3 currentPlayerPoint = cam.ScreenToWorldPoint(Input.mousePosition);
                currentPlayerPoint.z = 15;
                tl.RenderLine(mouseStartPoint, currentPlayerPoint);
            }
        }
